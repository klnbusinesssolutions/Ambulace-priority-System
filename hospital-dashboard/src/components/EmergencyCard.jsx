...
function EmergencyCard({ emergency, onSelect, selected = false, displayId, ambulanceLabel }) {
  ...
  return (
    ...
    >
      ...
      <div className="emergency-meta">
        <span>
          <FiTruck /> {ambulanceLabel || emergency.ambulanceId}
        </span>
        <span>
