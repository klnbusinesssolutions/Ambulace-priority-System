...
function LiveTracking() {
  ...
  // Stable oldest->newest order so EMG001 always points to the same incident
        ...
        <aside className="panel tracking-list glass-card">
            ...
            <div className="routing-panel" style={{ marginBottom: 12 }}>
              <div className="routing-panel-header">
                <div>
                  ...
                  <strong>
                    {selectedEmergency.patientName || emergencyIdMap.get(selectedEmergency.id) || selectedEmergency.id}
                  </strong>
                </div>
              </div>
              {routeInfo ? (
          ...
          {!loading &&
            emergencies.map((emergency) => (
              ...
              >
                <div>
                  <strong>{resolveAmbulanceLabel(emergency.ambulanceId, ambulances)}</strong>
