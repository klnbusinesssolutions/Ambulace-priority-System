...
export const COLLECTIONS = {
  ...
  // submissions from the police dashboard; flipping a request's `status` to
  // "approved" triggers createPoliceOfficerCredentialsOnApproval (Cloud
  // Function), which creates the Auth account and the `police_officers/{uid}`
  // profile doc — mirrors the driver approval flow.
  pendingPoliceOfficers: "pending_police_officers",
  policeOfficers: "police_officers",
  // Temp password generated by the Cloud Function above, keyed by the
