...
export function OpsProvider({ children }) {
  ...
  const pendingPoliceOfficersActions = {
    ...
    requestResubmission: (request, reason) => requestPoliceOfficerResubmission(request, reason),
  ...
  const value = useMemo(() => {
    ...
    const rejectedRequests =
      ...
      pendingPoliceOfficers.filter((officer) => officer.status === VERIFICATION_STATUS.rejected).length;
